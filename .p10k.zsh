# Generated by Powerlevel10k configuration wizard on 2024-03-25 at 03:29 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=45
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=50
  ...
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=50
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=38
  ...
  #########################[ proxy: system-wide http/https/ftp proxy ]##########################
  # Proxy color.
  typeset -g POWERLEVEL9K_PROXY_FOREGROUND=122
  ...
  typeset -g POWERLEVEL9K_WIFI_BACKGROUND=122
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=64
